...
// Mapped onto THIS app's tokens — the registry's bg-popover assumes a shadcn
// theme that doesn't exist here and resolved to transparent (owner caught it).
const VARIANT: Record<TooltipVariant, string> = {
  default: "bg-void border border-white/15 shadow-xl",
  "frosted-glass": "bg-void/85 border border-white/15 shadow-xl backdrop-blur-md",
}
